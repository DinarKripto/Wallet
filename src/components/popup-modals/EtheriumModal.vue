            ...
            <div class="tab-pane" id="22">
              ...
              <div v-if="sendEtherTxHash">
                <div class="form-group" style="margin-top: 20px;">
                  ...
                  <input type="text" v-model="sendEtherTxHash" class="form-control" />
                </div>
              </div>
            </div>
          ...
          setTimeout(function() {
            ...
            setTimeout(function() {
              ...
              response.then(res => {
                ...
                var etherTokenError = res.toString().split(":")[2];
                // console.log("Ether error " + etherTokenError);
                // console.log("etehr token tx hash  " + res.toString().split(':')[2]);
                if (etherTokenError) {
                  alertify.set("notifier", "position", "top-right");
                  alertify.error(etherTokenError);
                  _this.sendEtherTxHash = "";
                  $("#Mintt").show();
                } else {
