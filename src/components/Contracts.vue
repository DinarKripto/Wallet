        ...
        <div class="col-md-12 col-md-offset-2">
          <div class="row">
            <ul class="nav nav-pills">
              <li class="active">
                <a data-toggle="pill" href="#home">Send Tokens</a>
              </li>
              <li>
                <a data-toggle="pill" @click="step = false" href="#menu1">Burn</a>
              </li>
              <li>
                <a data-toggle="pill" @click="step = false" href="#menu2">Mint</a>
              </li>
              <li>
                <a data-toggle="pill" @click="step = false" href="#menu3">Pause</a>
              </li>
              <li>
                <a data-toggle="pill" @click="step = false" href="#menu4">UnPause</a>
              </li>
              <li>
                <a data-toggle="pill" @click="step = false" href="#menu5">Update Rate</a>
              </li>
            </ul>
            <div class="col-md-8">
