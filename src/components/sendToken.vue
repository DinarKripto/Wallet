            ...
            <div class="col-md-8">
              <div class="tab-content">
                <div id="home" class="tab-pane fade in active">
                  <div class="tab-content">
                    <h1 class="title-eth m-t-10 text-left">Send DNC</h1>
                    <div id="Mintt" class="tab-pane active">
                      ...
                      >
                        <div class="form-group">
                          <label>Recipient Address {{$route.params.id}}</label>
                          <input
                            type="text"
                            id="target-field"
                            placeholder="Address"
...
//var web3 = new Web3(new Web3.providers.HttpProvider("https://rinkeby.infura.io/t2utzUdkSyp5DgSxasQX"));
...
export default {
  ...
  methods: {
    getAddressAndTokenValues: async function(toAddress, tokenValue) {
      var _this = this;
      // console.log("token value: "+tokenValue);
      var tokenValue = web3.utils.toWei(tokenValue, "ether");
      // console.log("token value: "+tokenValue);
      _this.dncData = contract.methods
        .transfer(toAddress, tokenValue)
        .encodeABI();
      return _this.dncData;
    },

    sendDNCTokens: async function(fromAddress, toAddress, tokenValue, userKey) {
      var _this = this;
      let tokenData = await _this.getAddressAndTokenValues(
        toAddress,
        tokenValue
      );
      ...
      web3.eth
        ...
        .then(count => {
          ...
          var privKey = new Buffer(userKey, "hex");
          ...
          //       _this.txResposne = transactionHash;
          //     } else {
          //        console.log("Line 571 --->  Error is " + error);
          //       _this.txError = error;
          //       txHash = error;
          //     }
          //   });
        ...
        _this
          ...
          .then(res => {
            ...
            if (jsonBackResposne) {
              ...
              _this.sendDNCTokens(fromAddress, toAddress, amount, userKey);
